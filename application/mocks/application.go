...
// MockProductPersistenceIntyerface is a mock of ProductPersistenceIntyerface interface.
type MockProductPersistenceIntyerface struct {
	ctrl     *gomock.Controller
	recorder *MockProductPersistenceIntyerfaceMockRecorder
}

// MockProductPersistenceIntyerfaceMockRecorder is the mock recorder for MockProductPersistenceIntyerface.
type MockProductPersistenceIntyerfaceMockRecorder struct {
	mock *MockProductPersistenceIntyerface
}

// NewMockProductPersistenceIntyerface creates a new mock instance.
func NewMockProductPersistenceIntyerface(ctrl *gomock.Controller) *MockProductPersistenceIntyerface {
	mock := &MockProductPersistenceIntyerface{ctrl: ctrl}
	mock.recorder = &MockProductPersistenceIntyerfaceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProductPersistenceIntyerface) EXPECT() *MockProductPersistenceIntyerfaceMockRecorder {
	return m.recorder
}

// Get mocks base method.
func (m *MockProductPersistenceIntyerface) Get(id string) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Get indicates an expected call of Get.
func (mr *MockProductPersistenceIntyerfaceMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockProductPersistenceIntyerface)(nil).Get), id)
}

// Save mocks base method.
func (m *MockProductPersistenceIntyerface) Save(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", product)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Save indicates an expected call of Save.
func (mr *MockProductPersistenceIntyerfaceMockRecorder) Save(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProductPersistenceIntyerface)(nil).Save), product)
}
